...
export const createNoveltySlice = (
  ...
  setComparisons: (comparisons) => {
    ...
    for (const comp of comparisons) {
      createNovelty(comp).catch((e) => console.error("[NoveltySlice] createNovelty error:", e));
    }
  ...
  addComparison: (comparison) => {
    ...
    createNovelty(comparison).catch((e) => console.error("[NoveltySlice] createNovelty error:", e));
    return set((prev) => ({ comparisons: [...prev.comparisons, comparison] }));
  },
  updateComparison: (comparison) => {
    debugNoveltySliceLog("updateComparison:", { id: comparison.id });
    updateNovelty(comparison).catch((e) => console.error("[NoveltySlice] updateNovelty error:", e));
    return set((prev) => ({
  ...
  removeComparison: (id) => {
    ...
    deleteNovelty(id).catch((e) => console.error("[NoveltySlice] deleteNovelty error:", e));
  ...
  clearComparisonsByCase: (caseId) => {
    ...
    deleteNoveltyByCaseId(caseId).catch((e) => console.error("[NoveltySlice] deleteNoveltyByCaseId error:", e));
    return set((prev) => ({
